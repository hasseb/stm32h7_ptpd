...
#define DEFAULT_AP                      8//0x1F
#define DEFAULT_AI                      64//0x3FF
...
#define DEFAULT_PARENTS_STATS           true
...
#define DEFAULT_CALIBRATED_OFFSET_NS    100000     // Offset from master < 100us -> calibrated
#define DEFAULT_UNCALIBRATED_OFFSET_NS  1000000   // Offset from master > 1000us -> uncalibrated
#define MAX_ADJ_OFFSET_NS               10000000  // Max offset to try to adjust it < 10ms

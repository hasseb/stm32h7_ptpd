...
/** 
  ...
  */ 
#define ETH_PTPTSCR     ((uint32_t)0x00000B00)  /*!< PTP TSCR register */
#define ETH_PTPSSIR     ((uint32_t)0x00000B04)  /*!< PTP SSIR register */
#define ETH_PTPTSHR     ((uint32_t)0x00000B08)  /*!< PTP TSHR register */
#define ETH_PTPTSLR     ((uint32_t)0x00000B0C)  /*!< PTP TSLR register */
#define ETH_PTPTSHUR    ((uint32_t)0x00000B10)  /*!< PTP TSHUR register */
#define ETH_PTPTSLUR    ((uint32_t)0x00000B14)  /*!< PTP TSLUR register */
#define ETH_PTPTSAR     ((uint32_t)0x00000B18)  /*!< PTP TSAR register */
#define ETH_PTPTTHR     ((uint32_t)0x00000B1C)  /*!< PTP TTHR register */
#define ETH_PTPTTLR     ((uint32_t)0x00000B20)  /* PTP TTLR register */
